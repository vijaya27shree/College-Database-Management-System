...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=1";
...
Computer Science Cybernetics<br>
Cloud Computing, Embedded Systems, IoT, Video Processing and Analytics, Parallel and Distributed Systems
...
<p><b style="color: orangered;">
Qualification</b><br>
<a style="color: green;">2015</a><br>
M.Tech<br>
Manakula Vinayagar Institute of Technology</p>
</td></table>
</center>
</body>