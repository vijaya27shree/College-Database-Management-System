...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=13";
...
<p> <b style="color: orangered;"> Personal Information</b><br>
    Mr E Pugazhendi<br>
    Male<br>
    DEPARTMENT OF INFORMATION TECHNOLOGY (IT) MADRAS INSTITUTE OF TECHNOLOGY (MIT), ANNA UNIVERSITY, CHENNAI<br>
    Kanchipuram, Tamil Nadu, India - 600025<br>
</p>
<p> <b style="color: orangered;">Expertise</b><br>
    Computer Science Information Systems<br>
    OOPS, Data Structures, C#.NET, Java Programming<br>
</p>
<p><b style="color: orangered;">
    Experience</b><br>

    <a style="color: green;">2010 - Present</a><br>
Teaching Fellow<br>
