...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=21";
...
Microwave Processing of Materials, Biomaterials, Surface Engineering, Nanomaterials,<br>
 Injection Moulding, Glass Fibre Manufacturing
</p>
<p><b style="color: orangered;">
    Qualification</b><br>
    2009<br>
