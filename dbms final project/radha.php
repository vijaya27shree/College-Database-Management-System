...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=20";
...
Dr Radha Senthilkumar<br>
Female<br>
Information Technology MIT CAMPUS, ANNA UNIVERSITY<br>
Chennai, Tamil Nadu, India - 600044
</p>
<p> <b style="color: orangered;">Expertise</b><br>
Computer Science Artificial Intelligence<br>
The main research interests are Data Mining and Knowledge Discovery, <br>
focusing on developing novel methods that produce interpretable models.
</p>
