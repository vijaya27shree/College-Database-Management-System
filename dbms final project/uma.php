...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=16";
...
Dr S Umamaheswari<br>
Female<br>
MIT Department of Information Technology, Anna University<br>
Chennai, Tamil Nadu, India - 600044<br>
</p>
<p> <b style="color: orangered;">Expertise</b><br>
Computer Science Information Systems<br>
VLSI, Embedded Systems, Machine Learning, Image Processing
</p>
