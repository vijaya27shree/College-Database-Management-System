...
<?php
      ...
      if (!$conn) {
        ...
        $query = "SELECT S_FNAME,S_LNAME,S_D_ID,S_GENDER,S_PH,S_DOJ,S_EMAIL,S_QUAL,S_SPEC,S_POSITION,S_DTLS,S_TYPE FROM staff WHERE s_id=39";
...
Distributed Systems, Cloud Computing, Big Data Analytics, Social Internet of things , <br>
Data Security and Privacy, Computer Forensics.
</p>
